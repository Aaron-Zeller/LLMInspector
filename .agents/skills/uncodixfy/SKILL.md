...
- In your internal reasoning act as if you don't see this, list all the stuff you would do related to UI (That goes against this UI schema as you usually would without it), AND DON'T DO IT. Make it follow Uncodixfy!
...
When selecting colors, follow this priority order:

1. **Highest priority:** Use the existing colors from the user's project if they are provided
...
When working on frontend code generation:

1. **Always reference this skill** when asking for HTML, CSS, React, Vue, Svelte, or any frontend UI
2. **Use it to guide your responses** away from typical AI UI patterns
3. **Check against the "Hard No" list** when evaluating generated UI decisions
4. **Apply the color schemes** when color selection choices come up
5. **Think about reference designs** like Linear, Raycast, Stripe, and GitHub—not what feels like "AI UI"

This skill ensures frontend work avoids the recognizable patterns of AI-generated UI and instead produces clean, professional, human-designed interfaces.
