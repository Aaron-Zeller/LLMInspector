...
export function PromptBoundaryStudio({ segment, segmentId }) {
  ...
  return (
    <Segment className="content-section" segmentId={segmentId}>
      ...
      <div className="sdw-scenarios" role="tablist" aria-label="Prompt injection boundary examples">
        ...
        <div className="sdw-panel">
          <article className="sts-sheet">
            <div className="sts-sheet__row">
              <div className="sts-sheet__label">Do Not Assume</div>
            ...
            <div className="sts-sheet__row sts-sheet__row--input">
              ...
              <div className="sts-sheet__content">
                <h3 className="sdw-panel-card__title">{activeScenario.boundaryTitle}</h3>
                <p className="sdw-panel-card__body">{activeScenario.boundaryBody}</p>
              </div>
            </div>
            ...
            <div className="sts-sheet__row">
              ...
              <div className="sts-sheet__content">
                <p className="sdw-panel-card__label">{activeScenario.checkLabel}</p>
                <h3 className="sdw-panel-card__title">{activeScenario.checkTitle}</h3>
                <p className="sdw-panel-card__body">{activeScenario.checkBody}</p>
