...
function LensPanel({ scenario, lensId }) {
    ...
    return (
      <div className="sdw-panel-grid">
        <article className="sdw-panel-card sdw-panel-card--output">
          <p className="sdw-panel-card__label">Granted Agency</p>
        ...
        <article className="sdw-panel-card">
          <p className="sdw-panel-card__label">Why It Feels Attractive</p>
  ...
  if (lensId === 'impact') {
    return (
      <div className="sdw-panel-grid">
        <article className="sdw-panel-card sdw-panel-card--output">
          <p className="sdw-panel-card__label">If The System Acts Alone</p>
  ...
  return (
    <div className="sdw-panel-grid">
      <article className="sdw-panel-card sdw-panel-card--output">
        <p className="sdw-panel-card__label">Your Supervision Move</p>
    ...
    <Segment className="content-section" segmentId={segmentId}>
      ...
      <div className="sdw-case">
        ...
        <div className="sdw-summary">
          ...
          <article className="sdw-summary__item">
            <p className="sdw-summary__label">Your Supervision Decision</p>
