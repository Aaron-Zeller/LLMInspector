...
export function PlatformGovernanceStudio({ segment, segmentId }) {
  ...
  return (
    <Segment className="content-section" segmentId={segmentId}>
      ...
      <div className="sdw-scenarios" role="tablist" aria-label="Platform governance examples">
      ...
      <div className="sdw-case">
        ...
        <div className="sdw-panel">
          <article className="sts-sheet">
            ...
            <div className="sts-sheet__row sts-sheet__row--platform">
            ...
            <div className="sts-sheet__row">
              <div className="sts-sheet__label">Governance Check</div>
              <div className="sts-sheet__content">
