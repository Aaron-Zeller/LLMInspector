...
export function VerificationWorkflowStudio({ segment, segmentId }) {
  ...
  return (
    <Segment className="content-section" segmentId={segmentId}>
      ...
      <div className="sdw-scenarios" role="tablist" aria-label="Verification workflow examples">
        ...
        <div className="sdw-panel">
          <article className="sts-sheet">
            <div className="sts-sheet__row">
              <div className="sts-sheet__label">Do Not Approve</div>
            ...
            <div className="sts-sheet__row">
              <div className="sts-sheet__label">Review Standard</div>
              <div className="sts-sheet__content">
