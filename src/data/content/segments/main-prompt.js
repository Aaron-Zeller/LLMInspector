export const mainPromptSegments = {
  ...
  'main-prompt-mechanism': {
    type: 'moduleIntro',
    paragraphs: [
      'LLMs generally treat all input as a single stream of instructions. They often struggle to distinguish between the system prompt, the user prompt, and the retrieved content. They treat all input as a single stream of instructions.',
