export const mainOversightSegments = {
  ...
  'main-agency-intro': {
    type: 'moduleIntro',
    paragraphs: [
      'Up until now, we have discussed the risks of the model giving us bad information. But the risk profile of Generative AI shifts entirely when the model is granted **"agency"**—the ability to act independently, make decisions, or trigger external events.',
  ...
  'main-agency-risks': {
    ...
    paragraphs: [
      ...
      '1. **Unsanctioned Operations:** An autonomous agent tasked with optimising cloud infrastructure might unexpectedly delete active servers, or an AI managing supply chain orders might execute massive, unauthorised financial purchases based on a hallucinated market trend.',
      '2. **Cascading System Failures:** Because AI agents operate at machine speed, a flawed decision can trigger a domino effect across interconnected components before a human even realises an error has occurred.',
