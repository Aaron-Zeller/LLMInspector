...
const newItems = {
  ...
  'post-pps1': makeScenario({
    ...
    options: [
      ...
      { id: 'ask-ai-confirm', title: 'Option B', description: 'Ask the AI to confirm the citation exists and proceed if it does.' },
      { id: 'locate-verify', title: 'Option C', description: 'Locate the IMF Digital Economy Report 2024, navigate to page 47, and confirm the 31% figure independently before use.' },
  ...
  'post-pps2': makeScenario({
    ...
    options: [
      { id: 'excessive-agency', title: 'Option A', description: 'Excessive AI agency — a client-facing commitment was made without human approval, regardless of the outcome.' },
      { id: 'efficient', title: 'Option B', description: 'Efficient use of AI capabilities — this is exactly what calendar integration is for.' },
...
export const PRE_NEW_SECTIONS = [
  ...
  },
  {
    ...
    description: 'Two workplace scenarios. Review each situation and choose the most defensible response.',
    introParagraphs: [
      'These scenarios ask you to judge a concrete situation: identify the risk, then decide what you would do.',
    ],
  ...
  },
  {
    ...
    description: 'Identify which parts of a workplace prompt should be removed before it is sent to an AI tool.',
    introParagraphs: [
      'AI literacy starts before a prompt is sent. This task checks whether you can spot what should never reach the model.',
    ],
    callout: {
      variant: 'warn',
      icon: '⚠',
      title: 'Input governance in practice',
      body: 'Select every span you would remove or replace before sending this prompt. Missing a risky span or flagging a safe one both affect your score.',
    },
    itemIds: ['pre-pat1'],
  },
  {
    ...
    description: 'Review an AI-assisted workflow and identify the steps that introduce governance or safety risk.',
    introParagraphs: [
      'AI failures often come from a chain of plausible decisions rather than one obvious mistake. This task asks you to spot where that chain goes wrong.',
    ],
    callout: {
      variant: 'warn',
      icon: '⚠',
      title: 'Click every risky step',
      body: 'Some steps are safe and some are risky. Select every step you judge to be problematic. Click again to deselect.',
    },
    itemIds: ['pre-edt1'],
  },
  {
    ...
    callout: {
      ...
      body: 'There are no right or wrong answers here. Rate your current confidence as accurately as you can.',
    },
